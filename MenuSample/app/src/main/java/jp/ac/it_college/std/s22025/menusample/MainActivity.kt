...
import jp.ac.it_college.std.s22025.menusample.databinding.ActivityMainBinding


class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainBinding
    private val menuList = mutableListOf<jp.ac.it_college.std.s22025.menusample.Menu>()
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_options_manu_list, menu)
        return true
    }
    ...
    private fun resetMenu(list: List<jp.ac.it_college.std.s22025.menusample.Menu>):Boolean{
        menuList.clear()
