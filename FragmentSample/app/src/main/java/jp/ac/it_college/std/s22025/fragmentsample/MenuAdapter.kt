...
import jp.ac.it_college.std.s22025.fragmentsample.databinding.MenuRowBinding

class MenuAdapter(private val data: List<Menu>) : RecyclerView.Adapter<MenuAdapter.ViewHolder>() {
